...
Example Routes:
    /artist_name/Gustav%20Klimt
    /artist_name/Andy%20Warhol
...
Copy Commands:
\copy stolen_art FROM 'interpol_classified_stolen_art.csv' DELIMITER ',' CSV

\copy artist_origin FROM 'artists.csv' DELIMITER ',' CSV
